        ...
        for layer, shape in zip(self.layers, self.output_shapes):
            if isinstance(layer, FlowStep):
                ...
                if layer.level == 0:
                    ...
                    # conditional_feature1 = torch.cat([y1, F.interpolate(y1, scale_factor=1, mode='nearest')],1)
        ...
        for layer, shape in zip(reversed(self.layers), reversed(self.output_shapes)):
            if isinstance(layer, FlowStep):
                ...
                if layer.level == 1:
                    ...
                    # conditional_feature1 = torch.cat([z, F.interpolate(z, scale_factor=1, mode='nearest')],1)
